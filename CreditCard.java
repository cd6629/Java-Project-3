...
public class CreditCard {
	...
	public CreditCard(Person cardHolder, String type, double creditLimit) {
		...
		public void makeCharge(Item item){
			if(item.getPrice() <= (creditLimit - currentBalance)) { //OR: (creditLimit - currentBalance >= item.getPrice())
			...
			double availableCredit = (double)Math.round(creditLimit - currentBalance);
